...
You can add via CDN using the address: [https://unpkg.com/mic-recorder-to-mp3@2.0.0](https://unpkg.com/mic-recorder-to-mp3@2.0.0). You can find the minified version in the same address, ex: [https://unpkg.com/mic-recorder-to-mp3@2.0.0/dist/index.min.js](https://unpkg.com/mic-recorder-to-mp3@2.0.0/dist/index.min.js)
